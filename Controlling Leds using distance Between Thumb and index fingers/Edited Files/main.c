...
{
	rxData[Size] = '\0';
	strncpy((char *)rxData2 ,(char *)rxData , sizeof(rxData2));

	if(strcmp((char *)rxData , "LED 1 ON") == 0){
		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_SET);
		HAL_GPIO_WritePin(GPIOG, GPIO_PIN_13, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOG, GPIO_PIN_14, GPIO_PIN_RESET);
	}else if(strcmp((char *)rxData , "LED 2 ON") == 0)
	{
		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOG, GPIO_PIN_13, GPIO_PIN_SET);
		HAL_GPIO_WritePin(GPIOG, GPIO_PIN_14, GPIO_PIN_RESET);
	}else if(strcmp((char *)rxData , "LED 3 ON") == 0)
	{
		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(GPIOG, GPIO_PIN_13, GPIO_PIN_RESET);
	...
	HAL_UARTEx_ReceiveToIdle_IT(&huart1, rxData, 10);
}
/**
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /* Uart init GPIO */
  // Configure the UART GPIO pins (TX and RX)
...
{
  /* USER CODE BEGIN 5 */
  HAL_UARTEx_ReceiveToIdle_IT(&huart1, rxData, 11);
  /* Infinite loop */
  for(;;)
  {
